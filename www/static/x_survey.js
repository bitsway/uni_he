...
function selectRoute() { 
	...
	var selected_routeDay=selected_routeArray[1];
	//alert (today_get);
						...
						if (result==''){
							...
							if (resultArray[0]=='SUCCESS'){
								...
								for (var o=0; o < outletSingleTtotal-1; o++){
									...
									//outletStringShow=outletStringShow+'nadira'
...
//								alert (i.toString())
						...
						//=====================Create Fixed Display list
								...
								for (var slab=0; slab < fdisplaySlabTotal-1; slab++){
										...
										fdisplayStringShow=fdisplayStringShow+'<img height="100px" width="100%"  src="fixedDisplay.png" alt="FixedDisplay" />';
										fdisplayStringShow=fdisplayStringShow+'<table width="100%" border="0" cellpadding="0" cellspacing="0">'
										fdisplayStringShow=fdisplayStringShow+'<tr bgcolor="#9FCED7" ><td width="1%" >&nbsp;</td><td >Item</td> <td>QTY</td><td></td><td>Face Up</td><td></td><td>Visible</td></tr>'
		...
		//								alert (i.toString())
								...
								for (var slab=0; slab < qpdsSlabTotal-1; slab++){
										...
										qpdsStringShow=qpdsStringShow+'<img height="100px" width="100%"  src="fixedDisplay.png" alt="FixedDisplay" />';
										qpdsStringShow=qpdsStringShow+'<table width="100%" border="0" cellpadding="0" cellspacing="0">'
										qpdsStringShow=qpdsStringShow+'<tr bgcolor="#9FCED7" ><td width="1%" >&nbsp;</td><td >Item</td> <td>QTY</td><td></td><td>Face Up</td><td></td><td>Visible</td></tr>'
...
//===============MHSKUS data==================
	...
	//mhskus_data=mhskus_data+"mhskus_data_end"
	//alert (mhskus_data);
	...
	for (var i=0; i < localStorage.fdisplaySlabTotal-1; i++){
		...
		for (var d=0; d < fdTotal-1; d++){
			...
			fdisplay_data=fdisplay_data+Itemfdisplay+'fdfd'+ItemQtyfdisplay+'fdfd'+ItemFaceupfdisplay+'fdfd'+ItemVisiblefdisplay+'fdfd'+slabfdisplay+'fdfd'+fdSLfdisplay+'fdfd'+image+'rdrd'
		}
						...
						if (result==''){
							...
							if (resultArray[0]=='SUCCESS'){
								...
								var m_date=newArray[3]
							     ...
							     var m_new = localStorage.m_new;
								 m_new=m_new+'</br><font color="#00007D">Item:&nbsp;&nbsp;  </font>'+item_name+'<font color="#00007D">  &nbsp;&nbsp; Brand: &nbsp;&nbsp;  </font>'+brand_name+'<font color="#00007D">&nbsp;&nbsp; InsDate: &nbsp;&nbsp;  </font>'+m_date+'<font color="#00007D">&nbsp;&nbsp; Qty:&nbsp;&nbsp;  </font>'+qty
